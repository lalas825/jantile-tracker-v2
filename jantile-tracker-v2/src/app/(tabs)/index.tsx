...
const ActiveProjectsWidget = () => (
    <View className="mb-20">
        <Text className="text-white font-medium mb-4">Active Projects</Text>
...
export default function Dashboard() {
    return (
        <SafeAreaView className="flex-1 bg-slate-900 text-slate-100" edges={['top']}>
            <ScrollView className="px-5 pt-4">
                <Header />

                {/* Charts Disabled for Web Debug */}
                <View className="p-6 bg-slate-800 rounded-xl mb-6">
                    <Text className="text-white font-bold opacity-50 text-center">Charts Temporarily Disabled for Web Debug</Text>
                </View>
