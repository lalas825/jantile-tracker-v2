...
export const AppSchema = new Schema([
    ...
    new Table({
        ...
        columns: [
            ...
            new Column({ name: 'pieces_per_crate', type: ColumnType.INTEGER }),
            new Column({ name: 'qty_damaged', type: ColumnType.REAL }),
            new Column({ name: 'qty_missing', type: ColumnType.REAL }),
    ...
    new Table({
        ...
        columns: [
            ...
            new Column({ name: 'supervisor_approved', type: ColumnType.INTEGER }),
            new Column({ name: 'foreman_approved', type: ColumnType.INTEGER }),
            new Column({ name: 'field_modified', type: ColumnType.INTEGER }),
            new Column({ name: 'created_by', type: ColumnType.TEXT }),
            new Column({ name: 'created_at', type: ColumnType.TEXT }),
            new Column({ name: 'updated_at', type: ColumnType.TEXT }),
        ]
    ...
    new Table({
        ...
        columns: [
            ...
            new Column({ name: 'received_qty', type: ColumnType.REAL }),
            new Column({ name: 'item_cost', type: ColumnType.REAL }),
            new Column({ name: 'created_at', type: ColumnType.TEXT }),
        ]
    }),
    new Table({
        name: 'material_claims',
        columns: [
            new Column({ name: 'po_id', type: ColumnType.TEXT }),
            new Column({ name: 'material_id', type: ColumnType.TEXT }),
            new Column({ name: 'expected_qty', type: ColumnType.REAL }),
            new Column({ name: 'received_qty', type: ColumnType.REAL }),
            new Column({ name: 'difference', type: ColumnType.REAL }),
            new Column({ name: 'pieces_expected', type: ColumnType.REAL }),
            new Column({ name: 'pieces_received', type: ColumnType.REAL }),
            new Column({ name: 'pieces_difference', type: ColumnType.REAL }),
            new Column({ name: 'condition_flag', type: ColumnType.TEXT }),
            new Column({ name: 'notes', type: ColumnType.TEXT }),
            new Column({ name: 'photo_url', type: ColumnType.TEXT }),
            new Column({ name: 'created_by', type: ColumnType.TEXT }),
            new Column({ name: 'created_at', type: ColumnType.TEXT }),
    ...
    new Table({
        ...
        columns: [
            ...
            new Column({ name: 'message', type: ColumnType.TEXT }),
            new Column({ name: 'link', type: ColumnType.TEXT }),
            new Column({ name: 'type', type: ColumnType.TEXT }),
