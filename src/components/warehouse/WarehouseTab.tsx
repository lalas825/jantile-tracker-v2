...
import { Box, Truck, ArrowRight, ArrowLeft, CheckCircle, ShoppingCart, AlertCircle, Calendar } from 'lucide-react-native';
...
type ViewMode = 'schedule' | 'outbound' | 'receiving' | 'inventory' | 'direct' | 'delivered' | 'claims';
        ...
        <View className="flex-1 bg-slate-50">
            ...
            <View className="bg-white border-b border-slate-200 pt-6 px-8 pb-0">
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row">
                    {renderTab('schedule', 'Schedule', Calendar)}
            ...
            <View className="flex-1">
                {viewMode === 'schedule' && <WarehouseSchedule />}
                {viewMode === 'outbound' && <OutboundList />}
                {viewMode === 'receiving' && <ReceivingList />}
